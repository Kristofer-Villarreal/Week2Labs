...
public class BooleanConditionalsLoops {
	...
	public static void main(String[] args) {
		...
		//try changing the values of age and hasLicense and not the different results
		...
		//create a new conditional and prints "Milk Please" if costOfMilk is less than 2.50
		...
		//use a conditional to print the following based on the following conditionals:
		//if there are 0 cookies remaining, print "Sad Face"
		//if there are less than 2 cookies, print "Yes!"
		//if there are less than 5 cookies, print "Woohoo!"
		...
		//using a switch, set the value of loyaltyMemberDiscount based on the following loyaltyMemberState scale
		...
		//create a conditonal that prints "login successful" if the username is "Tommy123" and the password is "12345"
		//otherwise, print "access denied"
		
		String username = "Jerry123";
		...
		//write a for loop that prints every others number from 0 to 100
		
		for (int i = 0; i <= 100; i++) { //or i += 2
			if (i % 2 == 0) {
				System.out.println(i);
			}
		}
